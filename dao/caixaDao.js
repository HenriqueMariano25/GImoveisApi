...
module.exports = {
    cadastrar: (caixa, idUsuario) => {
        return new Promise((resolve, reject) => {
            ...
            '${caixa.movimento}', ${caixa.valor}, ${caixa.id_debito_credito}, '${caixa.historico}',
    ...
    visualizarTodos: () => {
        return new Promise((resolve, reject) => {
            db.query(`SELECT cai.id, cai.movimento, cai.id_debito_credito, cai.id_historico historico, cai.complemento_historico,
    ...
    editar: (caixa, idUsuario) => {
        return new Promise((resolve, reject) => {
            db.query(`UPDATE caixa SET movimento = '${caixa.movimento}', id_historico = '${caixa.historico}', 
